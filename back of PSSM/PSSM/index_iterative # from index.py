...
# @Last Modified time: 2018-09-04 15:52:08
import torch
import numpy as np
import os
import time
...
def pre_matching(start,end):
    ...
    for i in range(int(start),int(end)):
        ...
        s_plane=[
        np.array(s_plane_x_0),
        np.array(s_plane_y_0),
        np.array(s_plane_x_1),
        np.array(s_plane_y_1),
        np.array(s_plane_x_2),
        np.array(s_plane_y_2),
        np.array(s_plane_x_3),
        np.array(s_plane_y_3),
        ...
        l_plane=[
        np.array(l_plane_x_0),
        np.array(l_plane_y_0),
        np.array(l_plane_x_1),
        np.array(l_plane_y_1),
        np.array(l_plane_x_2),
        np.array(l_plane_y_2),
        np.array(l_plane_x_3),
        np.array(l_plane_y_3),
