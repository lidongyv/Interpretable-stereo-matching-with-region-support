...
import numpy as np
import time
#remove=np.loadtxt(r'/home/dataset2/sceneflow/monkey_clean_pass/all_unused_files.txt')
remove=[]
with open(r'/home/dataset2/sceneflow/monkey_clean_pass/all_unused_files.txt','r') as f:
    data=f.readlines()
    for line in data:
        line=line.split()[0]
        remove.append(line)
...
disparity_dir=r'/home/dataset2/sceneflow/monkey_dispairty/'
