...
# @Last Modified time: 2018-09-20 21:12:32
import numpy as np
import os
import time
...
def pre_processing(start,end):
    output_dir=r'/home/dataset2/flying3d/train/left_re/'
    ...
    for f in range(int(start),int(end)):
        ...
        np.save(os.path.join(P_dir,P_files[f]),[])
        #print(time.time()-start_time)
        print(os.path.join(output_dir,P_files[f]))

    output_dir=r'/home/dataset2/flying3d/train/right_re/'
    P_dir=r'/home/dataset2/flying3d/train/right/'
    P_files=os.listdir(P_dir)
    P_files.sort()
